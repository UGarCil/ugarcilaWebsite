...
# CONSTANTS
PATH = os.getcwd()
itemRef = "proceduralArt.png"
ITEMSINROW = 1
# Data def. RES
# res_% = int
# % is resolution
# interp. resolution of Arkanoid blocks. The values are calculated based on the number of pixels of the base
# of the original spritesheet image (24 for width, 15 for height), and rescaling the base to resolutions
# that range from 16 * 24 = 
res_0 = 16 * ITEMSINROW
res_32 = 32 * ITEMSINROW
res_64 = 64 * ITEMSINROW
res_128 = 128 * ITEMSINROW
res_256 = 256 * ITEMSINROW
...
lores0 = [res_0 ,res_32 ,res_64 ,res_128 ,res_256 ]
...
for res in lores:
    new_dir = jn(PATH, f"res_{str(res//ITEMSINROW)}")
